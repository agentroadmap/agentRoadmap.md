...
export async function updateReadmeWithBoard(states: State[], statuses: string[], projectName: string, version?: string) {
	...
	await exportKanbanBoardToFile(states, statuses, tempPath, projectName);
