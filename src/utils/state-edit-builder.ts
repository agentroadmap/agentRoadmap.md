import type { StateUpdateInput } from "../types/index.ts";
import type { StateEditArgs } from "../types/state-edit-args.ts";
import { normalizeStringList } from "./state-builders.ts";
...
export function buildStateUpdateInput(args: StateEditArgs): StateUpdateInput {
