/**
 * Upsert the state updated_date field in markdown frontmatter while preserving body content.
 */
export function upsertStateUpdatedDate(content: string, updatedDate: string): string {
