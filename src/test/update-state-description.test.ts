...
import { updateStateDescription } from "../markdown/serializer.ts";
import { extractStructuredSection } from "../markdown/structured-sections.ts";

describe("updateStateDescription", () => {
...
Test plan`;
		...
		const result = updateStateDescription(content, "New description");
...
More detailed notes.`;
		...
		const result = updateStateDescription(content, "Updated description");
